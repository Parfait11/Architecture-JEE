package  enset.dimba.tp_3_spring_mvc.security;
...
public class SecurityConfig {
    ...
    public UserDetailsService userDetailsService(PasswordEncoder encoder) {
        return new InMemoryUserDetailsManager(
                User.withUsername("parfait").password(encoder.encode("1234")).roles("USER").build(),
                User.withUsername("roy").password(encoder.encode("1234")).roles("USER").build(),
